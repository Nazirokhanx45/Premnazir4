...
|  \/  | __ )|  ___|%s {au:Nazir}
%s| |\/| |  _ \| |_%s    {ig:AjMaL SHaH}
%s| |  | | |_) |  _|%s   {gh:github.com/Nazir5}
%s|_|  |_|____/|_|%s     {fb:https://www.facebook.com/NaZerkhaN521}
"""%(M,P,M,P,U,P,U,P))
# Proxy
try:
...
def ___login___():
    ...
    try:
        ...
        if ___cookie___ in ['open','Open']:
            ...
            os.system("xdg-open https://www.facebook.com/NaZerkhaN521");exit()
...
def ___password___():
    ...
    print("\n%s[%s•%s]%s Hasil Ok Tersimpan Di :%s Results/Aj.txt"%(B,P,B,P,H))
    print("%s[%s•%s]%s Hasil Cp Tersimpan Di :%s Results/Tor.txt\n"%(B,P,B,P,H))
